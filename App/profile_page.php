<!DOCTYPE html> <!--Maximus, überarbeitet von Marius, Maximus-->
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="container rounded bg-light shadow mb-5 text" style="height: 100%; width: 50%;">
    ...
    <div class="container" style="background-color:rgb(255,255,255,0.9)">
        <h1 class="h1 text-center rate-me_headline">Welcome <?php session_start();
            echo $_SESSION["user_username"]; ?></h1>
    </div>
    <?php
...
<div class="container rounded shadow mb-3 row">
    ...
    <div class="tenor-gif-embed ml-2" data-postid="16353173" data-share-method="host" data-aspect-ratio="1"
         data-width="5%"><a href="https://tenor.com/view/bang-my-head-irritated-oh-no-no-way-problematic-gif-16353173">Bang
            My Head Irritated Sticker</a>from <a href="https://tenor.com/search/bang+my+head-stickers">Bang My Head
            Stickers</a></div>
...
<div class="row">
    <div class="col">
        <?php if (sizeof($postIDs) > 0) {
            show_post($postIDs[0], false);
        } ?>
    </div>
    <div class="col">
        <?php if (sizeof($postIDs) > 1) {
            show_post($postIDs[1], false);
        } ?>
    </div>
    <div class="col">
        <?php if (sizeof($postIDs) > 2) {
            show_post($postIDs[2], false);
        } ?>
    </div>
    <div class="col">
        <?php if (sizeof($postIDs) > 3) {
            show_post($postIDs[3], false);
        } ?>
    </div>
</div>
